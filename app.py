...
logo_path = "assets/logo.png"  # Ganti dengan path logo Anda jika ada
try:
...
if predict_button:
    if input_text.strip() == "":
        ...
        model_path = 'Model/pickle/mnb_alpha_1.0_tuning_minimal_ratio_80_20.pkl'  # Path relatif
        vectorizer_path = 'Model/pickle/countvectorizer.pkl'  # Path relatif
        ...
        # Menghilangkan Penjelasan Alasan Prediksi
